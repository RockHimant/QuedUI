              ...
              <ul className="navbar-nav">
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    <Link to="/order-dashboard" className="dropdown-item">
                      {props.t("Orders")}
                    </Link>
                    <Link to="/order-dashboard2" className="dropdown-item">
                      {props.t("Orders2")}
                    </Link>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    {props.t("Active Orders")} <div className="arrow-down"></div>
                  </Link>
                  <div
                    className={classname(
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    {props.t("Pending Orders")} <div className="arrow-down"></div>
                  </Link>
